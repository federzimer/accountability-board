  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-[#f5f0ea] to-[#ede6dc]">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="bg-white rounded-2xl p-8 space-y-5 border border-[#ddd2c8] shadow-[0_4px_24px_rgba(61,28,28,0.06)]">
          <h2 className="text-xl font-bold text-center text-[#3d1c1c] font-[Playfair_Display,serif]">Welcome Back</h2>
          ...
          <p className="text-center text-[#8b7b7b] text-sm">
            ...
            <Link href="/signup" className="text-[#9b7a8f] hover:underline font-semibold">
              Join the Assembly
            </Link>
          </p>
        </form>
